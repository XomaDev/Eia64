...
data class NativeCall(
    ...
    companion object {
        private val FUNCTION_SIGNATURES = HashMap<Type, FunctionInfo>().apply {
            ...
            put(Type.INCLUDE, FunctionInfo(Sign.NONE, 1, listOf(Sign.STRING)))
