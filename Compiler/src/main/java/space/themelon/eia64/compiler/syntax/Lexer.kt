package space.themelon.eia64.compiler.syntax

import space.themelon.eia64.compiler.Compiler
import space.themelon.eia64.compiler.syntax.Type.Companion.KEYWORDS
...
class Lexer(private val source: String) {
    ...
    private fun parseChar(): Token {
        ...
        return Token(line, Type.E_CHAR, arrayOf(Flag.VALUE, Flag.CONSTANT_VALUE), char)
    }
    ...
    private fun parseString(): Token {
        ...
        return Token(line, Type.E_STRING, arrayOf(Flag.VALUE, Flag.CONSTANT_VALUE), content.toString())
    }
    ...
    private fun parseAlpha(c: Char): Token {
        ...
        return token?.normalToken(line) ?: Token(line, Type.ALPHA, arrayOf(Flag.VALUE), value)
    }
